...
import com.barl_inc.unusual_prehistory.client.animations.entity.mob.paleozoic.LobeFinnedFishAnimations;
...
public class LobeFinnedFishScaumenaciaModel extends UP2Model<LobeFinnedFish> {
	...
	public LobeFinnedFishScaumenaciaModel(ModelPart root) {
        super(0.5F, 24);
