...
public class JawlessFishFurcacaudaModel extends JawlessFishModel {
	...
	public JawlessFishFurcacaudaModel(ModelPart root) {
        super();
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = swim_control.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.75F, -1.0F, -1.0F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(20, -1).addBox(-0.25F, -3.0F, 1.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, -1.5F));
