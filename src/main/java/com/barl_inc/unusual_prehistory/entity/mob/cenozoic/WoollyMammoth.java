...
public class WoollyMammoth extends PrehistoricMob {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        WoollyMammoth baby = UP2Entities.WOOLLY_MAMMOTH.get().create(level);
        if (baby != null) {
    ...
    public ResourceLocation fallbackVariantTexture() {
        return UnusualPrehistory2.modPrefix("textures/entity/mob/woolly_mammoth/woolly_mammoth.png");
    }
