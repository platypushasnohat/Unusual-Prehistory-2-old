...
public class Pachyrhinosaurus extends PrehistoricMob {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        Pachyrhinosaurus baby = UP2Entities.PACHYRHINOSAURUS.get().create(level);
        if (baby != null) {
    ...
    public ResourceLocation fallbackVariantTexture() {
        return UnusualPrehistory2.modPrefix("textures/entity/mob/pachyrhinosaurus/pachyrhinosaurus.png");
    }
