...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Dimorphodon>> DIMORPHODON = registerEntity("dimorphodon", Dimorphodon::new, MobCategory.CREATURE, builder -> builder.sized(1.5F, 1.25F).eyeHeight(1.15F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Prognathodon>> PROGNATHODON = registerEntity("prognathodon", Prognathodon::new, MobCategory.WATER_CREATURE, builder -> builder.sized(3.25F, 2.5F).eyeHeight(1.25F).clientTrackingRange(10));
