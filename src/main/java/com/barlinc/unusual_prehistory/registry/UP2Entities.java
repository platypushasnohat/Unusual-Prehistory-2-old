...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Nihohae>> NIHOHAE = registerEntity("nihohae", Nihohae::new, MobCategory.WATER_CREATURE, builder -> builder.sized(0.9F, 0.7F).eyeHeight(0.35F).clientTrackingRange(10));
